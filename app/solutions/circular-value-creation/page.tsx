...
const SOLUTION_ID = "circular-value-creation" as const;
...
export default function CircularValueCreationPage() {
  return (
    <AppShell
      title={config.name}
      breadcrumb={[
      ...
      <div className="h-full overflow-y-auto">
        <div className="mx-auto max-w-6xl space-y-8 px-6 py-6">
          ...
          <section>
            ...
            <CaseAnalyticsPreview caseSolutionLabel="Circular Value Creation" />
          </section>
